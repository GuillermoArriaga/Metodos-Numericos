...
class MATRIZ{
   ...
   void hacia(char* Fmat);               // Graba vector
   ...
   void pivGAG();
   double ABS (double d);
   double RAIZ(double a, int iter=30);
   void DESintercambio();
...
// Eliminacion Gaussiana
   ...
   void PIVOTEOtotal(int columna);
   void PIVOTEOparcial(int columna);
